    ...
    public partial class frmThongTinDonVi : DevComponents.DotNetBar.Office2007Form
    {
        ...
        private void saveData()
        {
            var DonViMoi = new ThongTinDonViModel
            {
                ...
                CapTruongId = (int)cbbCapTruong.SelectedValue,
                DonViChuQuan = txtDonViChuQuan.Text,
                Email = txtEmail.Text,
                Fax = txtFax.Text,
                HangTruongId = (int)cbbHangTruong.SelectedValue,
                HieuTruong = txtHieuTruong.Text,
                HinhThucDaoTaoId = (int)cbbHinhThucDT.SelectedValue,
                IsDatChuanQG = cboxChuanQG.Checked,
                KeToan = txtKeToan.Text,
                KhoiTruongId = (int)cbbKhoiTruong.SelectedValue,
                LoaiHinhTruongId = (int)cbbLoaiTruong.SelectedValue,
                LoaiTruongChuyenBietId = (int)cbbLoaiTruongCB.SelectedValue,
                NguoiLapBieu = txtNguoiLapBieu.Text,
                PhuongXaId = (int)cbbPhuongXa.SelectedValue,
                QuanHuyenId = (int)cbbQuanHuyen.SelectedValue,
                TinhThanhId = (int)cbbTinhThanh.SelectedValue,
                VungMienId = (int)cbbDacBietVM.SelectedValue,
