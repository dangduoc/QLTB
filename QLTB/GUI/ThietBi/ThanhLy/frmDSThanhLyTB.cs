...
namespace QLTB.GUI
{
    public partial class frmDSThanhLyTB : DevComponents.DotNetBar.Office2007Form
    {
        ...
        private void ShowPage(int page, int pageSize)
        {
            ...
            List<PhieuTLGridDisplayModel> list = data.data;
            if (list.Count > 0)
            {
                loadData(list);
        ...
        private void loadData(List<PhieuTLGridDisplayModel> list)
        {
        ...
        private void btnSuaDSTB_Click(object sender, EventArgs e)
        {
            ...
            if (row != null)
            {
                ...
                frmPhieuThanhLyTB frm = new frmPhieuThanhLyTB(id);
                var owner = MdiParent as Form1;
                owner.OpenFrmChild(frm);
            }
        }
