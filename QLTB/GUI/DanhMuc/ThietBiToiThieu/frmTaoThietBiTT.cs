    ...
    public partial class frmTaoThietBiTT : DevComponents.DotNetBar.Office2007Form
    {
        ...
        private void saveData()
        {
            ThietBiToiThieuModel ThietBiMoi = new ThietBiToiThieuModel
            {
                ...
                DauMucId=MyConvert.To<int?>(cbbThuocDauMuc.SelectedValue),
                DonViTinhId=MyConvert.To<int>(cbbDVT.SelectedValue),
                MonHocId=MyConvert.To<int>(cbbMonHoc.SelectedValue),
                LoaiThietBiId=MyConvert.To<int>(cbbLoaiTB.SelectedValue),
                MoTa=txtMoTa.Text,
