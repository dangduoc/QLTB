...
namespace QLTB.GUI
{
    public partial class frmDMPhongBoMon : Form
    {
        ...
        private void LoadForm()
        {
            ...
            headers.Add("Mã phòng học");
            headers.Add("Tên");
            headers.Add("Loại phòng TN");
            headers.Add("Môn học");
            headers.Add("Diện tích");
            headers.Add("Số cán bộ");
            headers.Add("Năm đưa vào sản xuất");
            headers.Add("Là phòng chức năng");
