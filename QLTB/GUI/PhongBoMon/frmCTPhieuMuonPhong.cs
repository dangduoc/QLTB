...
namespace QLTB.GUI
{
    public partial class frmCTPhieuMuonPhong : DevComponents.DotNetBar.Office2007Form, IFrmPhieuBaseTB
    {
        private PhieuMuonPhongModel Phieu;
        ...
        public frmCTPhieuMuonPhong(string Id)
        {
            InitializeComponent();
        ...
        private void loadForm()
        {
            ...
            CbbPhongBoMon.DataSource = new DbPhongBMHandler().GetNames().Select(p => new { key = p.PhongHocId, value = p.Ten }).ToList();
            ...
            if (Phieu != null)
            {
                ...
                cboxNgoaiQuyDinh.Checked = Phieu.IsNgoaiQuyDinh;
                cboxSuDungCaNgay.Checked = Phieu.IsSuDungCaNgay;
                rdioGiangDay.Checked = Phieu.IsSuDungChoGD;
        ...
        private void frmCTPhieuMuonPhong_KeyDown(object sender, KeyEventArgs e)
        {
        ...
        {
            var PhieuMoi = new PhieuMuonPhongModel
            {

                PhieuMuonPhongId = txtSoPhieu.Text,
                SoTiet = Convert.ToInt32(txtSoTiet.Text),
                MucDichSDId = (int)CbbMucDichSD.SelectedValue,
                ...
                IsSuDungCaNgay=cboxSuDungCaNgay.Checked,
                IsSuDungChoGD=rdioGiangDay.Checked,
                IsDelete=false,
                PhongBoMonId=(int)CbbPhongBoMon.SelectedValue,
                TrangThaiId=0
            };
            if (Phieu == null)
            {
            ...
            else
            {
                ...
                Phieu.CreatedOnDate = Phieu.CreatedOnDate;
